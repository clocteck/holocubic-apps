...
local APP_DIR = rawget(_G, "XIAOZHI_UI_APP_DIR") or "/sd/apps/xiaozhi-service"
local SERVICE_DIR = rawget(_G, "XIAOZHI_SERVICE_DIR") or "/sd/apps/xiaozhi-service"

-- The service-owned driver and headless fallback live in /sd/apps/xiaozhi-service/ui.
